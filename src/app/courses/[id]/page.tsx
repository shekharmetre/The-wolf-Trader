...
import { ArrowLeft, Play, Lock, Star, Clock, Users, Award, CheckCircle, Target, BookOpen, TrendingUp, Shield, Tag, Gift, ChevronDown, ChevronUp } from "lucide-react";
...
import courseImage from "@/assets/course-technical-analysis.jpg";
                                ...
                                <div className="space-y-6 md:text-lg text-sm text-foreground/90 leading-relaxed">
                                    ...
                                    <div className="grid sm:grid-cols-3 gap-6 my-8">
                                        <div className="text-center p-6 bg-gradient-card rounded-lg border border-border">
                                            ...
                                            <p className="text-sm text-muted-foreground">Learn to read market trends and price action</p>
                                        </div>
                                        <div className="text-center p-6 bg-gradient-card rounded-lg border border-border">
                                            <Shield className="w-8 h-8 text-info mx-auto mb-3" />
                                            <h4 className="font-semibold text-foreground mb-2">Risk Management</h4>
                                            <p className="text-sm text-muted-foreground">Protect your capital with proven strategies</p>
                                        </div>
                                        <div className="text-center p-6 bg-gradient-card rounded-lg border border-border">
                                            <Award className="w-8 h-8 text-warning mx-auto mb-3" />
                                            <h4 className="font-semibold text-foreground mb-2">Professional Skills</h4>
                                            <p className="text-sm text-muted-foreground">Trade like a professional trader</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
